 ...
 * 
 */
public class BehaviorServerSerurityInterceptor implements Interceptor {
	private static final Logger logger = LoggerFactory
			.getLogger(BehaviorServerSerurityInterceptor.class);

	/**
	 * Only {@link HostInterceptor.Builder} can build me
	 */
	private BehaviorServerSerurityInterceptor() {
		logger.debug("初始化");
	}
	...
	public static class Builder implements Interceptor.Builder {
		...
		public Interceptor build() {
			return new BehaviorServerSerurityInterceptor();
		}
